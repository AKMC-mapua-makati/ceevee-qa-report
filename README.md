...
Compare actual results against expected output
Status

All test cases are designed for manual execution. Status values are maintained within individual test case files.
